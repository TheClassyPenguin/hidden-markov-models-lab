...
We see no evidence of decrease in the (conditional) entropy of hidden states ($Z^t | X^{0:T}$) as we collect more data (over time) -- see graph below. (NB: each Multinoulli distribution $Z^t | X^{0:T}$ was estimated as the 'Filtered' distibution)
